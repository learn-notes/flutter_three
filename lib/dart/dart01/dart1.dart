...
void main() => runApp(ComplexLayoutApp());
...
class ComplexLayoutApp extends StatefulWidget {
  ...
  static ComplexLayoutAppState of(BuildContext context) =>
      context.ancestorStateOfType(const TypeMatcher<ComplexLayoutAppState>());
}
...
class _ComplexLayout extends StatefulWidget {
  const _ComplexLayout({Key key}) : super(key: key);

  @override
  _ComplexLayoutState createState() => _ComplexLayoutState();

  static _ComplexLayoutState of(BuildContext context) =>
      context.ancestorStateOfType(const TypeMatcher<_ComplexLayoutState>());
}

class _ComplexLayoutState extends State<_ComplexLayout> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
